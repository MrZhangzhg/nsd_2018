# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2019-03-08 10:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('arg_text', models.CharField(max_length=100, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Host',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('modlue_name', models.CharField(max_length=50, unique=True)),
            ],
        ),
        migrations.AddField(
            model_name='host',
